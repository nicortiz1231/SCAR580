"""Probe enum equality nodes for primary/secondary swap guards."""
import unreal
from pathlib import Path

OUT = Path("/Users/nickortiz/Documents/Unreal Projects/SCAR-580/Scripts/probe_enum_eq.log")
lines = []
...
for node in editor.list_all_nodes():
    name = node.get_name()
    if name not in ("K2Node_EnumEquality_0", "K2Node_EnumEquality_6", "K2Node_CallFunction_279", "K2Node_CallFunction_248"):
        continue

"""Definitive UE 5.8 bodycam fix: opaque PP materials + physical camera exposure blowout."""
...
LOG_PATH = Path("/Users/nickortiz/Documents/Unreal Projects/SCAR-580/Scripts/fix_ue58_definitive.log")

PP_MATERIALS = [
    "/Game/BodycamFPSKIT/Blueprints/Materials/M_Outline",
    "/Game/BodycamFPSKIT/Blueprints/Camera/Materials/M_Vignette",
    "/Game/BodycamFPSKIT/Blueprints/Camera/Materials/M_FishEyeLens",
    "/Game/BodycamFPSKIT/Blueprints/Camera/Materials/M_FishEyeLens_Inst",
]
...
def log(msg: str) -> None:
    ...
    unreal.log(f"[fix_ue58_definitive] {msg}")
...
def fix_post_process_material(path: str) -> None:
    ...
    try:
        ...
        log(f"Could not read blend_mode on {path}: {exc}")
        return
...
def main() -> None:
    ...
    for material_path in PP_MATERIALS:
        fix_post_process_material(material_path)
